 ...
 */
package br.unifesp.testegrafo.exemplo;
...
public class jgrapht_demo {
     ...
     *
     * @param createCycles true - create a directed graph which contains cycles.
     * false - create a directed graph which does not contain any cycles.
     */
